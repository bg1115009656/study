...
@Table(name = "sign_ent_info")
public class SignEntInfo {
    /**
     * 签约企业编号
     */
    @Id
     ...
     * 设置签约企业名称
     *
     * @param signEntName 签约企业名称
     */
    public void setSignEntName(String signEntName) {
        this.signEntName = signEntName;
    }

    /**
     * 获取归属企业编号
     *
     * @return ENT_ID - 归属企业编号
     */
